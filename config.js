module.exports = {
	...
	adminId: "963485330709823569", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTE4MzEyMjQ5OTkwNzYzNzI5OA.Gnur6T.dSlNJmMEK4QmD6HZ2BC3dPG5ZrnB92yOkZQmAs", //- Bot's Token
	clientId: process.env.clientId || "1183122499907637298", //- ID of the bot
	clientSecret: process.env.clientSecret || "jVSzQnxtYstVwEyBSf8TICZ-uX2m9kaH", //- Client Secret of the bot
	...
	cookieSecret: "Alfredo_EC is epic", //- Cookie Secret
	website: "http://localhost:4200", //- without the / at the end
	// You need a lavalink server for this bot to work!!!!
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: "API Node", //- Used for indentifier in stats commands.
	...
	presence: {
		...
		activities: [
			{
				name: "Musicas devoradoras", //- Status Text
