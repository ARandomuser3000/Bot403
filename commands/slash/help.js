  ...
  .setRun(async (client, interaction) => {
    ...
    helpEmbed.addFields({
      ...
      value:
        ...
        "\n" +
        `[Roblox](https://www.roblox.com/users/2048726544/profile) | [Invite Me](https://discord.com/oauth2/authorize?client_id=${client.config.clientId}&permissions=${client.config.permissions}&scope=bot%20applications.commands)`,
    });
